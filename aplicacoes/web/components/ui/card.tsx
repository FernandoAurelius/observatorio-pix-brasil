...
/** Superfícies reutilizáveis, compatíveis com composição shadcn/ui. */
...
export function CardDescription({className,...props}:HTMLAttributes<HTMLParagraphElement>){return <p className={cn("muted small",className)} {...props}/>;}
