...
from nucleo_estatistico import histograma, simular_grandes_numeros, simular_limite_central
...
def teste_histograma_constante_grande():
    ...
    assert sum(
        classe["densidade"] * (classe["superior"] - classe["inferior"]) for classe in classes
    ) == testes.approx(1)
